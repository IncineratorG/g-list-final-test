...
export const SUBSCRIBE_TO_LOCAL_SIGN_IN_INFO_BEGIN =
  'SUBSCRIBE_TO_LOCAL_SIGN_IN_INFO_BEGIN';
export const SUBSCRIBE_TO_LOCAL_SIGN_IN_INFO_FINISHED =
  'SUBSCRIBE_TO_LOCAL_SIGN_IN_INFO_FINISHED';
export const SUBSCRIBE_TO_LOCAL_SIGN_IN_INFO_ERROR =
  'SUBSCRIBE_TO_LOCAL_SIGN_IN_INFO_ERROR';
export const UPDATE_LOCAL_SIGN_IN_INFO = 'UPDATE_LOCAL_SIGN_IN_INFO';
