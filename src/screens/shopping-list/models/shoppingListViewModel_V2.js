...
export const useShoppingListScreenModel = () => {
  ...
  const shoppingListName = useSelector(
    state => state.currentShoppingList.currentShoppingList.name,
  );
  const productsList = useSelector(
    state => state.currentShoppingList.currentShoppingList.products,
  );
  const listLoading = useSelector(
    state => state.currentShoppingList.currentShoppingList.loading,
  );
  const shared = useSelector(
    state => state.currentShoppingList.currentShoppingList.shared,
  );
  const currentSharedListLoading = useSelector(
    state => state.currentShoppingList.currentShoppingList.sharedListLoading,
  );
  const creator = useSelector(
    state => state.currentShoppingList.currentShoppingList.creator,
  );
