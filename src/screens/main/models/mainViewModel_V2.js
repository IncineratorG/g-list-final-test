...
export const useMainScreenModel = () => {
  ...
  const localListsLoading = useSelector(
    state => state.shoppingLists.allShoppingLists.localListsLoading,
  );
  const sharedListsLoading = useSelector(
    state => state.shoppingLists.allShoppingLists.sharedListsLoading,
  );
  const allShoppingLists = useSelector(
    state => state.shoppingLists.allShoppingLists.allLists,
  );
  const localShoppingLists = useSelector(
    state => state.shoppingLists.allShoppingLists.localLists,
  );
  const sharedShoppingLists = useSelector(
    state => state.shoppingLists.allShoppingLists.sharedLists,
  );
  ...
  useFocusEffect(
    useCallback(() => {
      dispatch(sl_subscribeToListOfShoppingLists());
