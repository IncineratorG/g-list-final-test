...
export const ProductRejected = ({styles, itemToRender, onStatusPress}) => {
  const statusPressHandler = () => {
    console.log('REJECTED_PRODUCT_STATUS_PRESS');
        ...
        <TouchableWithoutFeedback
          ...
          <View style={styles.statusContainer}>
            <View style={styles.statusFinished}>
              <Image style={styles.checmarkIcon} source={icons.warning} />
            </View>
          </View>
        </TouchableWithoutFeedback>
      </View>
